...
// -----------------------------
const translations = {
  en: { langHeader:"Language Selection", about:"About Me", special:"Special Features", playAll:"Play All", projects:"Project Selection", email:"Email", vimeo:"Vimeo", en:"English", es:"Spanish", fr:"French", pl:"Polish", menu: "Main Menu", other: "Other", reel: "Reel",
  ...
  es: { langHeader:"Selección de Idioma", about:"Sobre mí", special:"Funciones Especiales", playAll:"Reproducir todo", projects:"Selección de proyecto", email:"Correo", vimeo:"Vimeo", en:"Inglés", es:"Español", fr:"Francés", pl:"Polaco", menu: "Menú Principal", other: "Other", reel: "Reel",
  ...
  fr: { langHeader:"Choix de la langue", about:"À propos", special:"Fonctionnalités", playAll:"Tout lire", projects:"Sélection de projet", email:"Email", vimeo:"Vimeo", en:"Anglais", es:"Espagnol", fr:"Français", pl:"Polonais", menu: "Menu Principal", other: "Other", reel: "Bande démo",
  ...
  pl: { langHeader:"Wybór języka", about:"O mnie", special:"Funkcje specjalne", playAll:"Odtwórz wszystko", projects:"Wybór projektu", email:"Email", vimeo:"Vimeo", en:"Angielski", es:"Hiszpański", fr:"Francuski", pl:"Polski", menu: "Menu Główne", other:"Other", reel: "Reel",
