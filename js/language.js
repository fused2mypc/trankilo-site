...
// -----------------------------
const translations = {
  en: { langHeader:"Language Selection", about:"About Me", special:"Special Features", play:"Play", scenes:"Scene Selection", email:"Email", vimeo:"Vimeo", en:"English", es:"Spanish", fr:"French", pl:"Polish", menu: "Main Menu", bts: "Behind the Scenes", 
  ...
  es: { langHeader:"Selección de Idioma", about:"Sobre mí", special:"Funciones Especiales", play:"Reproducir", scenes:"Selección de Escenas", email:"Correo", vimeo:"Vimeo", en:"Inglés", es:"Español", fr:"Francés", pl:"Polaco", menu: "Menú Principal", bts: "Detrás de Cámaras",
  ...
  fr: { langHeader:"Choix de la langue", about:"À propos", special:"Fonctionnalités", play:"Lecture", scenes:"Sélection de scènes", email:"Email", vimeo:"Vimeo", en:"Anglais", es:"Espagnol", fr:"Français", pl:"Polonais", menu: "Menu Principal", bts: "Making-Of",
  ...
  pl: { langHeader:"Wybór języka", about:"O mnie", special:"Funkcje specjalne", play:"Odtwórz", scenes:"Wybór scen", email:"Email", vimeo:"Vimeo", en:"Angielski", es:"Hiszpański", fr:"Francuski", pl:"Polski", menu: "Menu Główne", bts:"Kulisy",
